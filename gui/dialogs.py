...
class DataPreviewDialog(QDialog):
    ...
    def __init__(
        ...
        hdr_x.setStyleSheet("font-weight:700; color:#26c6da; font-size:11px;")
        hdr_y = QLabel("Y")
        hdr_y.setFixedWidth(28)
        hdr_y.setAlignment(Qt.AlignCenter)
        hdr_y.setToolTip("Зависимая переменная (цель)")
        hdr_y.setStyleSheet("font-weight:700; color:#e040fb; font-size:11px;")
        hdr_col = QLabel("Столбец")
        hdr_col.setStyleSheet("font-weight:700; color:rgba(255,255,255,0.50); font-size:11px;")
        ...
        legend.setStyleSheet("font-size:11px; color:rgba(255,255,255,0.45); padding:4px 0;")
